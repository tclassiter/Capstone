...
<h1><font color = "white">Please Enter Payment Information</font></h1>
...
<input type = text name = CardExpiration placeholder = "Card Expiration Date">
<input type = text name = CardSecurity placeholder = "Security Code">

<input type="submit" value = "Submit Payment!" style="background-color: #00cc99;">
</form>
